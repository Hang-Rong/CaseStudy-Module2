...
public class GameMobile {
    ...
    public GameMobile(int gameID, String gameName, String liveServiceOrNot, String gameDate, String gamePublisher, String gameInfo, String gameStore) {
        this.gameID = gameID;
